...
<head>
    ...
    <title>@yield('title', 'SmartPED')</title>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            <div class="d-flex align-items-center">
                <img src="{{ asset('images/logo-white.png') }}" alt="SmartPED Logo" class="sidebar-logo me-2" onerror="this.style.display='none'">
                <h4 class="mb-0">SmartPED</h4>
            </div>
        </div>
