    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <input type="text" class="form-control @error('nomor_kontrak') is-invalid @enderror" id="nomor_kontrak" name="nomor_kontrak" value="{{ old('nomor_kontrak', $dokumen->nomor_kontrak) }}" placeholder="Masukkan nomor kontrak" required>
                @error('nomor_kontrak')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
